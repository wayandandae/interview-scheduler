...
// tests for getAppointmentsForDay(state, day)
...
// tests for getInterview(state, interview)
...
// tests for getInterviewersForDay(state, day)
...
test("getInterviewersForDay returns an array containing the correct interviewer objects", () => {
  ...
  // state fetching happens asynchronously so provide timeout
  setTimeout(() => {
...
test("getInterviewersForDay returns an empty array when interviewers are not found", () => {
